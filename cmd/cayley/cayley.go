...
var (
	...
	quadType           = flag.String("format", "cquads", `Quad format to use for loading ("cquads", "nquads" or "json").`)
	...
	dumpType           = flag.String("dump_type", "nquads", `Quad file format ("json", "nquads", "gml", "graphml").`)
